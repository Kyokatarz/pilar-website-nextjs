      ...
      introduction: {
        ...
        paragraph: {
          artistStatement: {
            ...
            our time (<em>do more, do faster, do better</em>). I do this mostly through 
            sound: I intend to create situations of sonic "underload" where the listener 
            can linger over reflection and contemplation. I believe in quietness, sparseness, 
            and simplicity to overcome the excess of information, fragmentation of the
            ...
            to listen better in order to hear</em> (Éliane Radigue, "The Mysterious Power 
            of the Infinitesimal"): The biggest step of my journey as an artist was to become 
            conscious that I am not conscious, and to strive for being conscious.<br/><br/>
            ...
            and others.<br/><br/>
            <em>...Promoting resting as a social action. We shouldn't rest to become
          ...
          acknowledgment: {
            ...
            Tza</em>). Thanks to Fluxus. Thanks to what is meaningless, useless, and empty according 
            to the mass-market society.
            <br />
            <br />
            And thanks to all artists yet to be discovered, lost in the ocean of information, that will 
            guide and inspire my work at some point. I am constantly searching for you.
            <br />
            <br />
            <br />`,
          },
          dev1: `<em>This open-source website has been kindly designed and developed by </em>`,
